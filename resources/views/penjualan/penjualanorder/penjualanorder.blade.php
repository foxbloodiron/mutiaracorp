...
@include('penjualan.penjualanorder.tambah_penjualanorder')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Penjualan</span> / <span class="text-primary" style="font-weight: bold;">Pencatatan Penjualan Dengan Order</span>
	     </p>
	</div>
				...
				<div class="card">
                    <div class="card-header bordered p-2">
                    	<div class="header-block">
		                    <h3 class="title"> Pencatatan Penjualan Dengan Order </h3>
		                </div>
