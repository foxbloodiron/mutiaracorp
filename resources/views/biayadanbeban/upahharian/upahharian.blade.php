...
@include('biayadanbeban.upahharian.tambah_upahharian')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Biaya dan Beban</span> / <span class="text-primary" style="font-weight: bold;">Upah Harian</span>
	     </p>
	</div>
