	...
	<div class="card">
		<div class="card-header bordered p-2">
	        ...
	        <div class="header-block pull-right">
                <a class="btn btn-primary" href="{{ route('datacanvassing.create') }}"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>	                    	
	        </div>
		</div>
							...
							<tr>
								...
								<td>
									<div class="btn-group btn-group-sm">
										<button class="btn btn-warning btn-edit-canv" type="button" title="Edit"><i class="fa fa-pencil"></i></button>
