...
<article class="content">
  ...
  <div class="title-block text-primary">
      <h1 class="title"> Proses Pencatatan Hasil Produksi </h1>
      <p class="title-description">
        <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> 
        / <span>Produksi</span> 
        / <a href="{{route('pencatatanhasil')}}"><span>Pencatatan Hasil Produksi</span> </a>
        / <span class="text-primary" style="font-weight: bold;">Proses Pencatatan Hasil Produksi</span>
       </p>
  </div>
        ...
        <div class="card">
                    <div class="card-header bordered p-2">
                      <div class="header-block">
                        <h3 class="title"> Proses Pencatatan Hasil Produksi </h3>
                      </div>
