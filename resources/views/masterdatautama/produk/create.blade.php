                ...
                <div class="card-block">
                    <section>
                      <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="form-group">
                            <input type="text" class="form-control form-control-sm" readonly="" name="dataproduk_code">
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="form-group">
                           <input type="number" class="form-control-sm form-control" min="0" readonly="" value="1" name="dataproduk_isisatuanutama">
                          </div>
                        </div>
