...
<article class="content">
  ...
  <div class="title-block text-primary">
      <h1 class="title"> Tambah Profil Data Pegawai </h1>
      <p class="title-description">
        <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data Utama</span>
         / <a href="#"><span>Kelola Profil Data Pegawai</span></a>
         / <span class="text-primary font-weight-bold">Tambah Profil Data Pegawai</span>
       </p>
  </div>
        ...
        <div class="card">
                    <div class="card-header bordered p-2">
                      <div class="header-block">
                        <h3 class="title">Tambah Profil Data Pegawai</h3>
                      </div>
