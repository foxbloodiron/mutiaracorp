...
<article class="content animated fadeInLeft">
  ...
  <div class="title-block text-primary">
      <h1 class="title"> Edit Data Variasi Satuan Produk </h1>
      <p class="title-description">
        <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data Utama</span>
         / <a href="{{route('agen.index')}}"><span>Data Agen</span></a>
         / <span class="text-primary" style="font-weight: bold;"> Edit Data Variasi Satuan Produk </span>
       </p>
  </div>
        ...
        <div class="card">
                    ...
                    <div class="card-header bordered p-2">
                      <div class="header-block">
                        <h3 class="title"> Edit Data Variasi Satuan Produk </h3>
                      </div>
