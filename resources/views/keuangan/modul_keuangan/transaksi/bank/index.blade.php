...
@section('title', 'Tambah Data Transaksi Bank')
    ...
    <div class="content-wrapper" id="vue-component">
      <div class="row">
        <div class="col-lg-12">
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb bg-info">
              ...
              <li class="breadcrumb-item active" aria-current="page">Input Transaksi Bank</li>
            </ol>
          </nav>
        </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Input Transaksi Bank</h4>
	...
	<script type="text/javascript">
		...
		var app = new Vue({
            ...
            mounted: function(){
                ...
                axios.get('{{route('transaksi.bank.form_resource')}}')
                          .then((response) => {
            ...
            methods: {
                saveData: function(evt){
                    ...
                    if($('#data-form').data('bootstrapValidator').validate().isValid()){
                        ...
                        axios.post('{{ route('transaksi.bank.store') }}', $('#data-form').serialize())
                                .then((response) => {
                                    // console.log(response.data);
                ...
                updateData: function(evt){
                    ...
                    if($('#data-form').data('bootstrapValidator').validate().isValid()){
                        ...
                        axios.post('{{ route('transaksi.bank.update') }}', $('#data-form').serialize())
                                .then((response) => {
                                    console.log(response.data);
                ...
                deleteData: function(evt){
                    ...
                    if(this.locked){
                        ...
                        if(cfrm){
                            ...
                            axios.post('{{ route('transaksi.bank.delete') }}', { tr_id: this.singleData.tr_id, _token: '{{ csrf_token() }}' })
                                    .then((response) => {
                                        // console.log(response.data);
                ...
                formReset: function(){
                    ...
                    $('#tr_type').val('BM').trigger('change.select2');
                    $('#tr_tanggal').val('{{ date('d/m/Y') }}');
                    $('#tr_value').val(0);
