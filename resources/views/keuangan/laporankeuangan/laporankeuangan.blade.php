...
@include('keuangan.laporankeuangan.tambah_laporankeuangan')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Keuangan</span> / <span class="text-primary" style="font-weight: bold;">Laporan Keuangan</span>
	     </p>
	</div>
