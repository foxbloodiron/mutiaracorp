				...
				<div id="contentnya">
					...
					{{-- Judul Kop --}}
						...
						<table width="100%" border="0" style="border-bottom: 1px solid #333;" {{-- v-if="pageNow == 1" v-cloak --}}>
				          <thead>
				            <tr>
				              <th style="text-align: left; font-size: 14pt; font-weight: 600; padding-top: 10px;" colspan="2">Laporan Buku Besar</th>
				            </tr>

				            <tr>
				              <th style="text-align: left; font-size: 12pt; font-weight: 500" colspan="2">{{-- {{ jurnal()->companyName }} --}} CV. Mutiara Berlian</th>
				            </tr>
