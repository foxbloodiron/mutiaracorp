...
@include('system.manajemenhakakses.tambah_manajemenhakakses')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Admin System</span> / <span class="text-primary" style="font-weight: bold;">Manajemen Hak Akses</span>
	     </p>
	</div>
