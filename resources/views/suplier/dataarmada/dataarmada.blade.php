...
@include('suplier.dataarmada.tambah_dataarmada')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Suplier</span> / <span class="text-primary" style="font-weight: bold;">Data Armada</span>
	     </p>
	</div>
