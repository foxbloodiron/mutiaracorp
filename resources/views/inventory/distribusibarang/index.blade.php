...
@include('inventory.distribusibarang.modal')
                    ...
                    <div class="card-block">
                        <section>
                        	...
                        	<div class="table-responsive">
	                            <table class="table table-striped table-hover display nowrap" cellspacing="0" id="table_distribusibarang">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var table = $('#table_distribusibarang').DataTable();

	$('#table_distribusibarang tbody').on('click', '.btn-edit', function(){

		window.location.href = '{{ route("distribusibarang.edit") }}';
