...
<article class="content animated fadeInLeft">
  ...
  <div class="title-block text-primary">
      <h1 class="title"> Edit Manajemen Stok </h1>
      <p class="title-description">
        <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Aktivitas Inventory</span>
         / <a href="#"><span>Manajemen Stok</span></a>
         / <span class="text-primary font-weight-bold">Edit Manajemen Stok</span>
       </p>
  </div>
                        ...
                        <section>
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="form-group">
                                <input type="number" class="form-control form-contol-sm" value="100">
                                </div>
                              </div>
