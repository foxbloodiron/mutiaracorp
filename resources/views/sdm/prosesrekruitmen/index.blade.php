	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
	    	 / <span>Aktifitas SDM</span>
	    	 / <span class="text-primary" style="font-weight: bold;">Proses Rekruitmen</span>
	     </p>
	</div>
                    ...
                    <div class="card-block">
                        <section>
                        	...
                        	<div class="table-responsive">
	                            <table class="table table-striped table-hover" cellspacing="0" id="table_rekruitmen">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var table = $('#table_rekruitmen').DataTable();
