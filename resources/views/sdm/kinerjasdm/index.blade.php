...
<article class="content">
	...
	<div class="title-block text-primary">
	    <h1 class="title">Kelola Kinerja SDM</h1>
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
	    	 / <span>Aktivitas SDM</span>
	    	 / <span class="text-primary" style="font-weight: bold;">Kelola Kinerja SDM</span>
	     </p>
	</div>
				...
				<div class="card">
                    <div class="card-header bordered p-2">
                    	<div class="header-block">
	                        <h3 class="title"> Data Kinerja SDM </h3>
	                    </div>
                    ...
                    <div class="card-block">
                        <section>
                        	...
                        	<div class="table-responsive">
	                            <table class="table table-striped table-hover" cellspacing="0" id="table_kinerja">
